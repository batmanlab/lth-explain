...
python /ocean/projects/asc170022p/shg121/PhD/Project_Pruning/main_lth_tcav.py  --dataset "cub"> $slurm_output

#python /ocean/projects/asc170022p/shg121/PhD/Project_Pruning/main_lth_tcav.py --dataset "HAM10k" >$slurm_output
